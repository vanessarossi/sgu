...
@Entity
@Table(name = "VW_UNRP_QUINTO_NIVEL_FLUXO")
public class QuintoNivelFluxo {
	...
	@Column(name = "codigo_quarto_nivel")
	private String codigoQuartoNivel;
	...
	public String getCodigoQuartoNivel() {
		return codigoQuartoNivel;
	}

	public void setCodigoQuartoNivel(String codigoQuartoNivel) {
		this.codigoQuartoNivel = codigoQuartoNivel;
	}
